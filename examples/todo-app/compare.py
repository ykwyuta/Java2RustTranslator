...
SCENARIO = [
    ...
    ("POST", "/todos", {"title": "急ぎの用事", "description": "", "dueDate": "", "priority": "HIGH"}),
    ("POST", "/todos", {"title": "不正な優先度", "description": "", "dueDate": "", "priority": "URGENT"}),
    ("POST", "/todos", {"title": "優先度なし", "description": "", "dueDate": "", "priority": ""}),
    ("GET", "/todos/4/edit", None),
    ("POST", "/todos/4", {"title": "急ぎの用事", "description": "", "dueDate": "", "priority": "LOW", "_done": "on"}),
